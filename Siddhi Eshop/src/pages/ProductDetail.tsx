        ...
        <div className="product-detail-grid">          
          ...
          <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "24px" }}>
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              <div className="selector-grid-mobile" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(65px, 1fr))", gap: "6px" }}>
                {coreOptions.map((core) => (
                  <button
                    key={core}
                    onClick={() => setSelectedCore(core)}
                    className="selector-btn-mobile"
                    style={{
                      padding: "5px 6px",
                      fontSize: "11px",
                      fontWeight: 700,
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              <div className="selector-grid-mobile" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(80px, 1fr))", gap: "6px" }}>
